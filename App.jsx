...
function Modal({title,onClose,children,width=520}){
  ...
  return(
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.65)",zIndex:200,display:"flex",alignItems:"flex-start",justifyContent:"center",padding:16,paddingTop:"8vh",overflowY:"auto"}}      onClick={e=>e.target===e.currentTarget&&onClose()}>
